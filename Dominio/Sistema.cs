...
namespace Dominio
{
    ...
    {
        #region Listas
        private List<Resena> Resenas { get; }
        ...
        /// </summary>
        public void AltaResena(Resena r)
        {
            try
            {
                ...
                {
                    throw new Exception("La reseña ya se encuentra ingresada");
                }
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Agrega un periodista a la lista de periodistas
        /// </summary>
        public void AltaUsuario(Usuario u)
        {
            try
            {
                ...
                {
                    throw new Exception("El periodista ya se encuentra ingresado");
                }
            }
            catch (Exception ex)
            {
        ...
        public void AltaPartido(Partido p)
        {
            try
            {
                ...
                {
                    if (Selecciones.Contains(p.Seleccion1) && Selecciones.Contains(p.Seleccion2))
                    {
                        p.Valido();
                        Partidos.Add(p);
                    }
                    ...
                    {
                        throw new Exception("Las selecciones no se encuentran cargadas");
                    }
                }
                else
                {
                    throw new Exception("El partido ya se encuentra ingresado");
                }
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Agrega una seleccion a la lista de selecciones
        /// </summary>
        public void AltaSeleccion(Seleccion s)
        {
            try
            {
                ...
                {
                    throw new Exception("La seleccion ya se encuentra ingresada");
                }
        ...
        public void AltaPais(Pais p)
        {
            try
            {
                ...
                {
                    throw new Exception("El país ya se encuentra ingresado");
                }
            }
            catch (Exception ex)
            {
        ...
        public void AltaJugador(Jugador j)
        {
            try
            {
                ...
                {
                    throw new Exception("El jugador ya se encuentra ingresado");
                }
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Devuelve la lista de selecciones
        /// </summary>
        ...
        /// <summary>
        /// Asigna el valor que se pasa por parámetro al monto de referencia para la categoría financiera de los jugadores
        /// </summary>
        public void CambiarMontoCategoria(double monto)
        {
            if (monto > 0)
            {
                Jugador.MontoCategoria = monto;
            }
            else
            {
                throw new Exception("El monto tiene que ser mayor que cero");
            }
        }

        /// <summary>
        /// Dado el id de un jugador, devuelve todos los partidos que dicho jugador haya disputado
        /// </summary>
        public List<Partido> PartidosDeUnJugador(int id)
        {
            ...
            {
                if (JugadoresDe(p.Seleccion1.Pais).Contains(jugadorABuscar) || JugadoresDe(p.Seleccion2.Pais).Contains(jugadorABuscar))
                {
                    lista.Add(p);
                }
            }
            if (lista.Count == 0)
            {
                throw new Exception("El jugador no ha participado en ningún partido");
            }
        ...
        /// <summary>
        /// Devuelve una lista con todos los jugadores que hayan sido expulsados al menos una vez
        /// </summary>
        public List<Jugador> JugadoresExpulsados()
        {
            ...
            foreach (Partido p in Partidos)
            {
                ...
                {
                    if (i.Tipo == TipoIncidencia.Expulsado && !lista.Contains(i.Jugador))
                    {
                        lista.Add(i.Jugador);
                    }
                }
            ...
            if (lista.Count == 0)
            {
                throw new Exception("No hay jugadores expulsados");
            }
            lista.Sort();
            lista.Reverse();
            return lista;
        ...
        /// <summary>
        /// Dado el nombre de una selección, retorna el/los partidos con mas goles que dicha selección haya disputado
        /// </summary>
        public List<Partido> PartidoMasGolesDeUnaSeleccion(string nombre)
        {
            List<Partido> lista = new List<Partido>();
            if (GetSeleccion(nombre) != null)
            {
                int cantidadGoles = int.MinValue;
                foreach (Partido p in Partidos)
                {
                    int contadorGoles = 0;
                    if (p.Seleccion1.Equals(GetSeleccion(nombre)) || p.Seleccion2.Equals(GetSeleccion(nombre)))
                    {
                        foreach (Incidencia i in p.GetIncidencias())
                        {
                            if (i.Tipo == TipoIncidencia.Gol)
                            {
                                contadorGoles ++;
                            }
                        }
                        if (contadorGoles > cantidadGoles)
                        {
                            cantidadGoles = contadorGoles;
                            lista.Clear();
                            lista.Add(p);
                        }
                        else if (contadorGoles == cantidadGoles)
                        {
                            lista.Add(p);
                        }
                    }
        ...
        /// <summary>
        /// Dado el id de un partido, devuelve el/los jugadores que hayan convertido al menos un gol en dicho partido
        /// </summary>
        public List<Jugador> JugadoresConAlMenosUnGol(int id)
        {
            List<Jugador> lista = new List<Jugador>();
            ...
            foreach (Partido p in Partidos)
            {
                if (p.Id == id)
                {
                    foreach (Incidencia i in p.GetIncidencias())
                    {
                        if (i.Tipo == TipoIncidencia.Gol && !lista.Contains(i.Jugador))
                        {
                            lista.Add(i.Jugador);
                        }
                    }
        ...
        private void PrecargarDatos()
        {
            ...
            Partido_FaseDeGrupos pfg1 = new Partido_FaseDeGrupos(NombreGrupo.H, GetSeleccion("Portugal"), GetSeleccion("Ghana"), new DateTime(2022, 11, 24, 13, 0, 0));
            pfg1.AgregarIncidencia(GetJugador("Rúben Neves"), TipoIncidencia.Gol, 21);
            pfg1.AgregarIncidencia(GetJugador("André Ayew"), TipoIncidencia.Amonestado, 73);
            pfg1.AgregarIncidencia(GetJugador("Osman Bukari"), TipoIncidencia.Expulsado, 87);
            pfg1.Finalizado = true;
            AltaPartido(pfg1);

            Partido_FaseDeGrupos pfg2 = new Partido_FaseDeGrupos(NombreGrupo.H, GetSeleccion("Portugal"), GetSeleccion("Uruguay"), new DateTime(2022, 11, 28, 16, 0, 0));
            pfg2.AgregarIncidencia(GetJugador("Luis Suárez"), TipoIncidencia.Gol, 89);
            pfg2.AgregarIncidencia(GetJugador("Luis Suárez"), TipoIncidencia.Gol, 89);
            pfg2.AgregarIncidencia(GetJugador("Bruno Fernandes"), TipoIncidencia.Amonestado, 52);
            pfg2.AgregarIncidencia(GetJugador("Danilo Pereira"), TipoIncidencia.Expulsado, 74);
            AltaPartido(pfg2);

            Partido_FaseDeGrupos pfg3 = new Partido_FaseDeGrupos(NombreGrupo.H, GetSeleccion("Portugal"), GetSeleccion("Corea del Sur"), new DateTime(2022, 12, 2, 12, 0, 0));
            pfg3.AgregarIncidencia(GetJugador("André Silva"), TipoIncidencia.Gol, 32);
            pfg3.AgregarIncidencia(GetJugador("Bruno Fernandes"), TipoIncidencia.Amonestado, 25);
            pfg3.AgregarIncidencia(GetJugador("Ji-soo Park"), TipoIncidencia.Expulsado, 51);
            AltaPartido(pfg3);

            Partido_FaseDeGrupos pfg4 = new Partido_FaseDeGrupos(NombreGrupo.H, GetSeleccion("Ghana"), GetSeleccion("Corea del Sur"), new DateTime(2022, 11, 28, 10, 0, 0));
            pfg4.AgregarIncidencia(GetJugador("Kwasi Wriedt"), TipoIncidencia.Gol, 77);
            pfg4.AgregarIncidencia(GetJugador("Felix Afena-Gyan"), TipoIncidencia.Amonestado, 10);
            pfg4.AgregarIncidencia(GetJugador("Dong-hyeon Kim"), TipoIncidencia.Expulsado, 62);
            AltaPartido(pfg4);

            Partido_FaseDeGrupos pfg5 = new Partido_FaseDeGrupos(NombreGrupo.H, GetSeleccion("Ghana"), GetSeleccion("Uruguay"), new DateTime(2022, 12, 2, 12, 0, 0));
            pfg5.AgregarIncidencia(GetJugador("Giorgian de Arrascaeta"), TipoIncidencia.Gol, 85);
            pfg5.AgregarIncidencia(GetJugador("Federico Valverde"), TipoIncidencia.Amonestado, 66);
            pfg5.AgregarIncidencia(GetJugador("Gideon Mensah"), TipoIncidencia.Expulsado, 81);
            AltaPartido(pfg5);

            Partido_FaseDeGrupos pfg6 = new Partido_FaseDeGrupos(NombreGrupo.H, GetSeleccion("Uruguay"), GetSeleccion("Corea del Sur"), new DateTime(2022, 11, 24, 10, 0, 0));
            pfg6.AgregarIncidencia(GetJugador("Diego Godín"), TipoIncidencia.Gol, 93);
            pfg6.AgregarIncidencia(GetJugador("Dong-hyeon Kim"), TipoIncidencia.Amonestado, 50);
            pfg6.AgregarIncidencia(GetJugador("Young-wook Cho"), TipoIncidencia.Expulsado, 70);
            pfg6.Finalizado = true;
            AltaPartido(pfg6);

            Partido_FaseDeGrupos pfg7 = new Partido_FaseDeGrupos(NombreGrupo.C, GetSeleccion("Argentina"), GetSeleccion("Arabia Saudita"), new DateTime(2022, 11, 22, 7, 0, 0));
            pfg7.AgregarIncidencia(GetJugador("Lautaro Martínez"), TipoIncidencia.Gol, 20);
            pfg7.AgregarIncidencia(GetJugador("Hassan Tambakti"), TipoIncidencia.Amonestado, 33);
            pfg7.AgregarIncidencia(GetJugador("Marcos Acuña"), TipoIncidencia.Expulsado, 82);
            AltaPartido(pfg7);

            Partido_FaseDeGrupos pfg8 = new Partido_FaseDeGrupos(NombreGrupo.C, GetSeleccion("Argentina"), GetSeleccion("México"), new DateTime(2022, 11, 26, 16, 0, 0));
            pfg8.AgregarIncidencia(GetJugador("Henry Martín"), TipoIncidencia.Gol, 78);
            pfg8.AgregarIncidencia(GetJugador("Lionel Messi"), TipoIncidencia.Gol, 88);
            pfg8.AgregarIncidencia(GetJugador("Rodrigo de Paul"), TipoIncidencia.Amonestado, 47);
            pfg8.AgregarIncidencia(GetJugador("Erik Lira"), TipoIncidencia.Expulsado, 31);
            pfg8.Finalizado = true;
            AltaPartido(pfg8);

            Partido_FaseDeGrupos pfg9 = new Partido_FaseDeGrupos(NombreGrupo.C, GetSeleccion("Argentina"), GetSeleccion("Polonia"), new DateTime(2022, 11, 30, 16, 0, 0));
            pfg9.AgregarIncidencia(GetJugador("Nicolás Otamendi"), TipoIncidencia.Gol, 71);
            pfg9.AgregarIncidencia(GetJugador("Nicolás González"), TipoIncidencia.Amonestado, 36);
            pfg9.AgregarIncidencia(GetJugador("Mateusz Klich"), TipoIncidencia.Expulsado, 14);
            AltaPartido(pfg9);

            Partido_FaseDeGrupos pfg10 = new Partido_FaseDeGrupos(NombreGrupo.C, GetSeleccion("Arabia Saudita"), GetSeleccion("Polonia"), new DateTime(2022, 11, 26, 10, 0, 0));
            pfg10.AgregarIncidencia(GetJugador("Przemyslaw Frankowski"), TipoIncidencia.Gol, 23);
            pfg10.AgregarIncidencia(GetJugador("Grzegorz Krychowiak"), TipoIncidencia.Amonestado, 44);
            pfg10.AgregarIncidencia(GetJugador("Sultan Al-Ghannam"), TipoIncidencia.Expulsado, 79);
            AltaPartido(pfg10);

            Partido_FaseDeGrupos pfg11 = new Partido_FaseDeGrupos(NombreGrupo.C, GetSeleccion("Arabia Saudita"), GetSeleccion("México"), new DateTime(2022, 11, 30, 16, 0, 0));
            pfg11.AgregarIncidencia(GetJugador("Sami Al-Najei"), TipoIncidencia.Gol, 10);
            pfg11.AgregarIncidencia(GetJugador("Orbelín Pineda"), TipoIncidencia.Amonestado, 36);
            pfg11.AgregarIncidencia(GetJugador("Marcelo Flores"), TipoIncidencia.Expulsado, 25);
            AltaPartido(pfg11);

            Partido_FaseDeGrupos pfg12 = new Partido_FaseDeGrupos(NombreGrupo.C, GetSeleccion("Polonia"), GetSeleccion("México"), new DateTime(2022, 11, 22, 13, 0, 0));
            pfg12.AgregarIncidencia(GetJugador("Luis Romo"), TipoIncidencia.Gol, 73);
            pfg12.AgregarIncidencia(GetJugador("Piotr Zielinski"), TipoIncidencia.Amonestado, 45);
            pfg12.AgregarIncidencia(GetJugador("Przemyslaw Placheta"), TipoIncidencia.Expulsado, 86);
            AltaPartido(pfg12);
            #endregion

            #region Partidos eliminatorios
            Partido_FaseEliminatoria pfe1 = new Partido_FaseEliminatoria(false, false, Etapa.Octavos, GetSeleccion("Uruguay"), GetSeleccion("Argentina"), new DateTime(2022, 12, 3));
            pfe1.AgregarIncidencia(GetJugador("Edinson Cavani"), TipoIncidencia.Gol, 52);
            pfe1.AgregarIncidencia(GetJugador("Nicolás González"), TipoIncidencia.Gol, 77);
            pfe1.AgregarIncidencia(GetJugador("Lionel Messi"), TipoIncidencia.Amonestado, 93);
            pfe1.AgregarIncidencia(GetJugador("Mathías Olivera"), TipoIncidencia.Expulsado, 80);

            pfe1.AgregarIncidencia(GetJugador("Federico Valverde"), TipoIncidencia.Gol, -1);
            pfe1.AgregarIncidencia(GetJugador("Nicolás de la Cruz"), TipoIncidencia.Gol, -1);
            pfe1.AgregarIncidencia(GetJugador("Darwin Núñez"), TipoIncidencia.Gol, -1);
            pfe1.AgregarIncidencia(GetJugador("Alexis Mac Allister"), TipoIncidencia.Gol, -1);
            pfe1.Alargue = true;
            pfe1.Penales = true;
            pfe1.Finalizado = true;
            AltaPartido(pfe1);

            Partido_FaseEliminatoria pfe2 = new Partido_FaseEliminatoria(false, true, Etapa.Octavos, GetSeleccion("México"), GetSeleccion("Portugal"), new DateTime(2022, 12, 4));
            pfe2.AgregarIncidencia(GetJugador("Sebastián Córdova"), TipoIncidencia.Gol, 123);
            pfe2.AgregarIncidencia(GetJugador("Bruno Fernandes"), TipoIncidencia.Amonestado, 2);
            pfe2.AgregarIncidencia(GetJugador("Erik Lira"), TipoIncidencia.Expulsado, 71);
            AltaPartido(pfe2);
            #endregion

            #region Periodistas
            AltaUsuario(new Periodista("Fabrizio", "Romano", "fabriziorom@gmail.com", "romano1234"));
            AltaUsuario(new Periodista("Rodrigo", "Romano", "rodrigorom@gmail.com", "rom12345"));
            AltaUsuario(new Periodista("Roberto", "Moar", "moarroberto@gmail.com", "moar1234"));
            AltaUsuario(new Periodista("Federico", "Buysan", "buysan@gmail.com", "buy12345"));
            #endregion

            #region Operador
            AltaUsuario(new Operador("Facundo", "Figueroa", "facundo@gmail.com", "12345678"));
            AltaUsuario(new Operador("Martín", "Rodríguez", "martin@gmail.com", "87654321"));
            #endregion

            #region Reseña
            AltaResena(new Resena(GetPeriodista(1), DateTime.Now, pfe1, "Triunfo agónico de Uruguay", 
                "Luego de alargue y penales, Uruguay derrotó a Argentina para avanzar a la siguiente fase"));
            AltaResena(new Resena(GetPeriodista(2), DateTime.Now, pfg8, "Empate justo",
                "Argentina se llevó un empate en los últimos minutos del partido"));
            #endregion
        }
        ...
        /// <summary>
        /// Realiza la precarga de las selecciones
        /// </summary>
        ...
        /// <summary>
        /// Retorna la selección a partir del nombre.
        /// </summary>
        private Seleccion GetSeleccion(string nombre)
        {
            foreach (Seleccion s in Selecciones)
            {
                if (nombre.ToLower() == s.Pais.Nombre.ToLower())
                {
                    return s;
                }
            }
        ...
        /// <summary>
        /// Retorna el jugador a partir del nombre.
        /// </summary>
        ...
        /// <summary>
        /// Retorna el usuario a partir del email y la password.
        /// </summary>
        ...
        /// <summary>
        /// Retorna una lista con los partidos finalizados.
        /// </summary>
        public List<Partido> GetPartidosCerrados()
        {
            List<Partido> listaRetorno = new List<Partido>();
            foreach (Partido p in Partidos)
            {
                if (p.Finalizado)
                {
        ...
        /// <summary>
        /// Retorna una periodista a partir del id.
        /// </summary>
        ...
        /// <summary>
        /// Retorna un partido a partir del id.
        /// </summary>
        ...
        /// <summary>
        /// Retorna todas las reseñas pertenecientes a un periodista.
        /// </summary>
        public List<Resena> GetResenasDePeriodista(int? id)
        {
            List<Resena> listaRetorno = new List<Resena>();
        ...
        /// <summary>
        /// Retorna todos los partidos que se disputaron entre dos fechas.
        /// </summary>
        public List<Partido> GetPartidosEntreFechas(DateTime fechaInicial, DateTime fechaFinal)
        {
            List<Partido> listaRetorno = new List<Partido>();
            foreach (Partido p in Partidos)
            {
                if (p.FechaHora.Date >= fechaInicial && p.FechaHora.Date <= fechaFinal)
                {
                    listaRetorno.Add(p);
                }
            }
        ...
        /// <summary>
        /// Devuelve una lista con todos los periodistas.
        /// </summary>
        public List<Periodista> GetPeriodistas()
        {
            List<Periodista> listaRetorno = new List<Periodista>();
            foreach (Usuario u in Usuarios)
            {
                if (u.GetTipo() == "Periodista")
                {
                    listaRetorno.Add((Periodista)u);
                }
            }
            listaRetorno.Sort();
            return listaRetorno;
        ...
        /// <summary>
        /// Devuelve los partidos donde hubo tarjeta roja, reseñados por determinado periodista
        /// </summary>
        public List<Partido> GetPartidosTarjetaRojaPeriodista(string email)
        {
            List<Partido> listaRetorno = new List<Partido>();
            foreach (Resena r in Resenas)
            {
                ...
                if (r.Periodista.Email.Equals(email))
                {
                    ...
                    {
                        if (i.Tipo == TipoIncidencia.Expulsado)
                        {
                            agregar = true;
                        }
                    }
        ...
        /// <summary>
        /// Devuelve la/las selecciones con más goles anotados
        /// </summary>
        public List<Seleccion> GetSeleccionesMasGoles()
        {
            List<Seleccion> listaRetorno = new List<Seleccion>();
            int cantMaxima = 0;
            foreach (Seleccion s in Selecciones)
            {
                int cantGoles = 0;
                foreach (Partido p in Partidos)
                {
                    if (p.Seleccion1.Equals(s) || p.Seleccion2.Equals(s))
                    {
                        foreach (Incidencia i in p.GetIncidencias())
                        {
                            if (i.Jugador.Pais.Equals(s.Pais) && i.Tipo == TipoIncidencia.Gol)
                            {
                                cantGoles++;
                            }
                        }
                ...
                if (cantGoles == cantMaxima)
                {
                    listaRetorno.Add(s);
                }
                else if (cantGoles >= cantMaxima)
                {
                    listaRetorno.Clear();
                    listaRetorno.Add(s);
                    cantMaxima = cantGoles;
                }
            }
            return listaRetorno;
        }
        ...
        /// Finaliza un partido
        /// </summary>
        public void FinalizarPartido(int id)
        {
